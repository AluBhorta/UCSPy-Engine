...
NUM_OF_TIMELSOTS = 10
NUM_OF_COURSES = 20
NUM_OF_INSTRUCTORS = 12

# secondary params
MAX_NUM_OF_LECS_PER_COURSE = 4
MIN_NUM_OF_LECS_PER_COURSE = 1

MAX_NUM_OF_QUALIFIED_COURSES_PER_INSTRUCTOR = NUM_OF_COURSES * 1.0
...
# (DO NOT MODIFY VARIABLES BELOW) inferred variables
