...
class UCSPSolver:
    ...
    \n
    :param params_folder: (optional) Path to the folder containing schedule_params to be used to generate the final schedule. To learn more about the schedule_params, refer to `README.md` or the whitepaper.
    \n
